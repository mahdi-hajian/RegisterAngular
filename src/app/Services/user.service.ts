...
export class UserService {
  ...
  IsUser() {
    ...
    return this.http.get(this.url + "/Account/IsUser", { headers: header });
  }
  ...
  IsAdmin() {
    ...
    return this.http.get(this.url + "/Account/IsAdmin", { headers: header });
  }
  ...
  IsLeader() {
    ...
    return this.http.get(this.url + "/Account/IsLeader", { headers: header });
  }
